...
function Layout({ children,authorized }: { children: React.ReactNode,authorized : boolean },) {
                  ...
                  <div className="flex space-x-4">
                    {navigation.map((item) => (
                      <Link
                        ...
                        aria-current={item.current ? 'location' : 'true'}
 ...
 const Footer = () => {
  return (
    <>
      <footer className={authorized ?'text-black fixed left-0 bottom-0 w-full text-center' : 'p-12 text-red-700 fixed left-0 bottom-0 w-full text-center'}>
